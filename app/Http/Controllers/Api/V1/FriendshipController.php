...
class FriendshipController extends Controller
{
    ...
    public function accept(AcceptFriendRequestRequest $request, Friendship $friendship): JsonResponse
    {
    ...
    public function reject(AcceptFriendRequestRequest $request, Friendship $friendship): JsonResponse
    {
