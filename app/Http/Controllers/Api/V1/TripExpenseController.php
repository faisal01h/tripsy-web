...
{
    public function store(StoreTripExpenseRequest $request, Trip $trip): JsonResponse
    {
    ...
    public function update(UpdateTripExpenseRequest $request, Trip $trip, TripExpense $tripExpense): JsonResponse
    {
        $this->authorize('addExpense', $trip);
