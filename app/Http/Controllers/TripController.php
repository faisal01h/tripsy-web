...
{
    public function __construct(public CurrencyConverter $currencyConverter) {}
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('trips/index', [
            ...
            'selectedTrip' => $selectedTrip === null ? null : $this->formatTrip($selectedTrip, $user),
    ...
    public function show(Request $request, Trip $trip): Response
    {
        ...
        $trips = $this->userTrips($user);
        $selectedTrip = $trips->firstWhere('id', $trip->id) ?? $trip;

        return Inertia::render('trips/index', [
            'trips' => $this->formatTripSummaries($trips),
            'selectedTrip' => $this->formatTrip($selectedTrip, $user),
            'acceptedFriends' => $this->acceptedFriends($user),
            'incomingFriendRequests' => $this->incomingFriendRequests($user),
            'outgoingFriendRequests' => $this->outgoingFriendRequests($user),
        ]);
    ...
    public function destroy(Trip $trip): RedirectResponse
    {
        ...
        return to_route('trips.index')->with('status', 'Trip deleted.');
    }
